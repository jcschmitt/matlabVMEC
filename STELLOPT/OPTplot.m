...
handles.chi_types={'ASPECT','BETA','CURTOR','EXTCUR','SEPARATRIX',...
    ...
    'REGCOIL_CHI2_B', 'REGCOIL_LAMBDA', 'REGCOIL_MAX_K', 'REGCOIL_RMS_K', ...
    'REGCOIL_VOLUME_COIL', 'REGCOIL_BNORMAL_TOTAL', ...
    'REGCOIL_COIL_PLASMA_DISTANCE_MIN', 'REGCOIL_max_Bnormal', 'GAMMA_C'};
...
switch stemp
    ...
    case{'CURTOR_chisq','VOLUME_chisq','BETA_chisq','ASPECT_chisq','KAPPA_chisq'...
            ...
            'CURVATURE_P2_chisq', ...
            'REGCOIL_CHI2_B_chisq', 'REGCOIL_LAMBDA_chisq', 'REGCOIL_MAX_K_chisq', ...
            'REGCOIL_RMS_K_chisq', 'REGCOIL_VOLUME_COIL_chisq', ...
            'REGCIOL_LAMBDA_chisq', 'REGCOIL_BNORMAL_TOTAL_chisq', ...
            'REGCOIL_COIL_PLASMA_DISTANCE_MIN_chisq', 'REGCOIL_max_Bnormal_chisq', ...
            'GAMMA_C_chisq'}
